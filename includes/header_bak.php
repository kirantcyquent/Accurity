...
.input-checkbox {
    ...
    *overflow: hidden;
	...
	<div class="container" style="width:100%;">
		...
		<div class="col-sm-8" style="text-align:right; padding:5% 10% 0% 0%;">	
		<span style="padding-right:128px; font-weight:bold; ">
		...
		<div style="padding:5px 0px 5px 5px; color:#000;"><span style="font-size:14px;">Call Us:</span> <span style="font-size:18px; font-weight:bold;">913.261.1800</span></div>
		<span class="label label-info" style="padding:5px 5px 5px 5px;">Accurity Membership Presentation</span>		
		</div>
		</div>
		<div class="row" style="margin-bottom:10px;">
		<div class="col-sm-2"></div>
		<div class="col-sm-10" id="topMenu">
